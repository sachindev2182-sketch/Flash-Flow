...
import HomeCategorySlider from "@/components/category/home/HomeCategorySlider";
import HomeCollection from "@/components/category/home/HomeCollection";
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">
            Loading Home & Living Collection...
          </p>
        </div>
      </div>
    );
      ...
      {showProfile && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-lg">
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white p-6 text-center relative rounded-t-2xl">
              <button
