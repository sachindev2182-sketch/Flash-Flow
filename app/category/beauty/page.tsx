...
import BeautyCategorySlider from "@/components/category/beauty/beautyCategorySlider";
import BeautyCollection from "@/components/category/beauty/beautyCollection";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <BeautyCategorySlider />
          <BeautyCollection user={user}/>
        </div>
      </main>
      <Footer />
      {/* Profile Modal */}
      {showProfile && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-lg">
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 text-center relative rounded-t-2xl">
              <button
