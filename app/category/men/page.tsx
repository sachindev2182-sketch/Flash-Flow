...
import MenCategorySlider from "@/components/category/men/MenCategorySlider";
import Mencollection from "@/components/category/men/Mencollection";
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="relative w-20 h-20 mx-auto mb-4">
            ...
            <div className="absolute top-0 left-0 w-full h-full border-4 border-[#5D5FEF] rounded-full border-t-transparent animate-spin"></div>
          </div>
