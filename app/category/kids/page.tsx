...
import KidsCategorySlider from "@/components/category/kids/KidsCategorySlider";
import KidsCollection from "@/components/category/kids/KidsCollection";
      ...
      {showProfile && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-lg">
            <div className="bg-gradient-to-r from-green-500 to-teal-500 text-white p-6 text-center relative rounded-t-2xl">
              <button
