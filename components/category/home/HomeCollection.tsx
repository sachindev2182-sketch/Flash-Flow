      ...
      try {
        if (isWishlisted) {
          ...
          const wishlistItem: Omit<WishlistItem, "id"> = {
            ...
            category: "Home", // Capitalized for wishlist
          };
...
export default memo(function HomeCollection({ user }: HomeCollectionProps) {
  ...
  }, [dispatch, homePagination.page, homePagination.productsPerPage]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Showing{" "}
            {(homePagination.page - 1) * homePagination.productsPerPage + 1} -{" "}
            {Math.min(
              homePagination.page * homePagination.productsPerPage,
              homePagination.totalProducts,
            )}{" "}
            of {homePagination.totalProducts} products
          </p>
        </div>
      </div>
