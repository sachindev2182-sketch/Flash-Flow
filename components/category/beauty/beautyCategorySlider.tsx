...
const slides: Slide[] = [
  {
    id: 1,
    image: "/beauty_slider_1.avif",
    alt: "Makeup Collection"
  },
  {
    id: 2,
    image: "/beauty_slider_2.jpg",
    alt: "Skincare Essentials"
  },
  {
    id: 3,
    image: "/beauty_slider_3.jpg",
    alt: "Fragrance Sale"
  },
  {
    id: 4,
    image: "/beauty_slider_4.jpg",
...
export default memo(function BeautyCategorySlider() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gray-100">
      <div className="relative w-full h-[280px] sm:h-[350px] md:h-[420px] lg:h-[500px] xl:h-[550px]">
        ...
        {/* Dots Indicator - Purple dots for beauty category */}
